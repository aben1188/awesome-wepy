...
- **合作方式：** 以服务器费用、运营费用等相关费用由哪方负责为基准，分为以下几种合作方式：
	...
	- 相关费用全部由我方负责，每月固定费用1000元+我方收取收入的30%~60%；
	- 其他合作方式：具体项目具体协商。

### :point_right: 月付15K以上找小程序/小游戏兼职程序员或外包团队
- **报酬：** 报酬可按周支付，同时可按收入分成，收入上不封顶
- **要求：**
	- 实际开发过从前端到后端完整的小程序(包括微信支付或红包功能)或小游戏的个人和团队；
	- 后端采用PHP或Node者优先；
	- 有社交红包类开发经验者或H5页游/手游开发经验者优先；
	- 在珠三角(尤其是深圳市)工作或居住者优先；
	- 能力出众、经验丰富的大牛级全栈开发者，以上三条优先条件均可忽略。
- **不看学历和履历，只看资历和能力**

:exclamation: <div style="color=#0099ff; font-size=12">**欢迎微信扫码联系**(请务必注明“**挂靠**”或“**小程序开发**”或“**小游戏开发**”以通过验证)：</div>
...
- **功能类组件**
	...
	- [wepy-antv-f2：antv/f2微信小程序wepy版本封装](https://github.com/Onlylonger/wepy-antv-f2)	
